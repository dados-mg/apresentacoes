...
- [INSERIR EXEMPLOS DE OUTROS PORTAIS DE DADOS ABERTOS COM ORGANIZACAO NO GITHUB]{.todo}

- https://github.com/dadosgovbr/
- https://github.com/GSA/data.gov/
- https://github.com/alphagov?q=data
- https://github.com/etalab/data.gouv.fr
- https://github.com/datosgcba/
- https://github.com/italia/?q=data
...
Solução - Parte 1: Adoção de um padrão para documentação dos dados (ie. metadados) que permita uma verificação/validação automatizável se os dados estão em conformidade com o especificado
...
---
# Glossário - Comma-separated values (CSV)

---
# Glossário - JavaScript Object Notation (JSON)